...
class LSTMVanillaStateful(AblationModel):
    """
    Vanilla LSTM cell implementation on PyTorch with statefulness.
    """

    def __init__(self, input_size, hidden_size, output_size, sever_recurrence=False):
        ...
        self.h_t = None
        self.c_t = None
        self.sever_recurrence = sever_recurrence
